...
def run_test_sum_of_digits():
    ...
    # Test 2:
    expected = 15
    actual = sum_of_digits(12345)
    print('Test 2 expected:', expected)
    print('       actual:  ', actual)

    # Test 3:
    expected = 25
    actual = sum_of_digits(34567)
    print("Test 3 expected:", expected)
    print("       actual:  ", actual)

    # Test 4:
    expected = 35
    actual = sum_of_digits(56789)
...
def digits_in_cube(n):
    ...
    #     if c == 0:
    #         break
    #     digit_sum = digit_sum + (c % 10)
    #     c = c // 10
    #
    # return digit_sum
    # ------------------------------------------------------------------
    cube = sum_of_digits(n*n*n)
    return cube
...
def run_test_digits_in_power():
    ...
    # Test 1
    expected = 1
    actual = digits_in_power(10, 3)
    print('Test 1 expected:', expected)
    print('       actual:  ', actual)

    # Test 2
    expected = 1
    actual = digits_in_power(10, 8)
    print('Test 2 expected:', expected)
    print('       actual:', actual)
