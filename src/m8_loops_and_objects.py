...
def draw_circles1():
    ...
    window = rg.RoseWindow(400, 400, 'draw_circles running')
    for i in range(20):
        circle = rg.Circle(rg.Point(200, 200), (10*i))
...
def draw_circles2():
    ...
    for i in range(18):
        circle = rg.Circle(rg.Point(50+20 * i, 100), 10)
...
def draw_cosines_and_sines():
    ...
    print('--------------------------------------------------')
    window = rg.RoseWindow(400, 400, 'cosines and sines')
    for i in range(1000):
